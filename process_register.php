...
if (!isset($_POST['i']) || trim($_POST['i']) == '') {
	die('you forgot to put in an invite code, jeez.');
}

if (!isset($_POST['e']) || trim($_POST['e']) == '') {
	die('you forgot to put in an email address, jeez.');
}
...
if (!isset($_POST['u']) || trim($_POST['u']) == '') {
	die('you forgot to put in a username, jeez.');
}
...
header('Location: /of/links/login/');